...
export function Channels() {
  ...
  if (chat.view === 'direct') {
    return (
      <div className="flex-1 overflow-auto busya-scroll px-3 pb-3">
        <div className="text-xs text-white/50 mb-2">{t(locale, 'channels.directs')}</div>
        <div className="space-y-2 mb-3">
          <input
            ...
            placeholder={t(locale, 'channels.searchUsers')}
            value={userQuery}
            onChange={async (e) => {
  ...
  return (
    <div className="flex-1 overflow-auto busya-scroll px-3 pb-3">
      <div className="text-xs text-white/50 mb-2">{t(locale, 'channels.channels')}</div>

      <div className="space-y-2 mb-3">
        <input
          className="w-full rounded-busya bg-busya-card/70 px-3 py-2 text-sm outline-none ring-1 ring-white/10 focus:ring-busya-pink/60"
          placeholder={t(locale, 'channels.newChannel')}
          value={name}
